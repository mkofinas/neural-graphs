...
from nn.original_nfn.layers.layer_utils import shape_wsfeat_symmetry
...
class UnflattenWeights(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> WeightSpaceFeatures:
        ...
        for i, (weight_spec, bias_spec) in enumerate(
            zip(self.network_spec.weight_spec, self.network_spec.bias_spec)
        ):
            ...
            wt = (
                ...
                .transpose(1, 2)
                .reshape(-1, n_chan, *weight_spec.shape)
            )
            ...
            bs = (
                ...
                .transpose(1, 2)
                .reshape(-1, n_chan, *bias_spec.shape)
            )
